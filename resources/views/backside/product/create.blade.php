...
@section('content')
    ...
    {{ Form::open(['url'=>'/backside/product', 'method'=>'post', 'files' => true]) }}
        ...
        <div class="form-group row">
            ...
            {!! Form::date('date_start',"",['class'=>'form-control col-md-2 col-4', 'id'=>'date-start', 'disabled']) !!}
        ...
        <div class="form-group row justify-content-md-center">
          ...
          <a href="/backside/product" class="btn btn-secondary col-md-2 offset-md-1 offset-2 col-4" role="button" aria-pressed="true">キャンセル</a>
        </div>
    {!! Form::close() !!}
