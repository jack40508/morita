...
@section('content')
<div class="container text-color-fontgray">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="/img/morita/consept-1.jpg" alt="consept-1" class='mb-3' id='imgConsept1'/>
        </div>
        <div class="col-md-8">
            <div class="row">
                <div class="col-12 test" id="conseptDivText2">
                    ...
                    <img src="/img/morita/consept-2.jpg" alt="consept-2" class="mw-100"/>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('/js/consept.js') }}"></script>
@endsection
